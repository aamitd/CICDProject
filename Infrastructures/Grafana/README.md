...
A running Linux-based server (e.g., Ubuntu, CentOS, or Debian). sudo or root access to the server. An internet connection for downloading Grafana.

Installation Steps

Install Grafana use the following commands to add the Grafana APT repository and install Grafana:
...
Log in with the default credentials: Username: admin Password: admin Then, change your password upon first login.
...
Uninstallation Grafana To uninstall Grafana, you can use the following commands:
